...
IN PROGRESS (Package 3AK — Import Insights Registry-Driven Dispatcher Consolidation, branch `feature/import-insights-registry`, stop-before-commit):
