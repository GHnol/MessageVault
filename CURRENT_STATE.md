...
| Active package | None |
| Test baseline | **3890 Node tests** (31 suites); E2E seeded 57/57; E2E real-files 195/195; visual regression Scenario A PASS 4/4 (Package P2 added the WhatsApp `toCanonical` hardened parse path: `whatsapp-txt-adapter-tests.mjs` 91→206, `km-engine-tests.mjs` 188→194; legacy path untouched, no app/UI change) |
