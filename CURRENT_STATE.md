...
| Active package | None |
| Test baseline | **3938 Node tests** (31 suites); E2E seeded 57/57; E2E real-files 195/195; visual regression Scenario A PASS 4/4 (Package P3 added participant-level self-ID to `toCanonical`: `whatsapp-txt-adapter-tests.mjs` 206→250, `km-engine-tests.mjs` 194→198; legacy path untouched, no app/UI change) |
