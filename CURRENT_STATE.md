...
| Active package | None |
| Test baseline | **3980 Node tests** (31 suites); E2E seeded 57/57; E2E real-files 195/195; visual regression Scenario A PASS 4/4 (Package P4 added evidence-based group detection + title/roster inference to `toCanonical`: `whatsapp-txt-adapter-tests.mjs` 250→286, `km-engine-tests.mjs` 198→204; legacy path untouched, no app/UI change) |
