...
| Active package | `Package 3AM — Import-Panels VR Verification-Gate Integration` — IN PROGRESS on `docs/import-panels-vr-gate`; Green Path docs/QA-only (wires import-panels VR into the pre-commit gate); no app/script/baseline/count change |
