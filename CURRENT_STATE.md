...
| Active package | None |
| Test baseline | **4068 Node tests** (32 suites); E2E seeded 57/57; E2E real-files 195/195; visual regression Scenario A PASS 4/4 (Package P5A added the native ZIP reader spike + manifest resolution: `whatsapp-zip-reader-tests.mjs` NEW 62, `whatsapp-txt-adapter-tests.mjs` 286→305, `km-engine-tests.mjs` 204→211; legacy path untouched, no app/UI change) |
