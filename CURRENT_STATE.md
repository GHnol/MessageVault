...
| Active package | None |
| Test baseline | **3769 Node tests** (31 suites); E2E seeded 57/57; E2E real-files 195/195; visual regression Scenario A PASS 4/4 (Package P1 added `canonical-conversation-tests.mjs` 116 + 8 km-engine smoke; engine-only, no app/UI change) |
