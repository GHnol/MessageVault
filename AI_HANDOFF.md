...
| **Active pass** | None |
| **Active branch** | `main` |
| **base HEAD** | `dd0ce0e` (docs: sync Tower docs after Package 3AK completion (Post-Package-3AK Tower Catch-Up); `main` HEAD — pre-closeout-commit value) |
| **Active package** | None |
