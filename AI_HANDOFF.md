...
| **Active pass** | None |
| **Active branch** | `main` |
| **base HEAD** | `a244463` (test: add import-insights panel visual regression scenario (Package 3AL); `main` HEAD — pre-state-sync-commit value) |
| **Active package** | None |
